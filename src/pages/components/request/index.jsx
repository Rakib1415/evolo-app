            ...
            <div className="row">
                <div className="col-lg-6">
                    <div className="text-container">
                        ...
                        <p>
                            Evolo is one of the easiest and feature packed marketing automation apps
                            in the market. Discover what it can do for your business organization
                            right away.
                        </p>
                        <ul className="list-unstyled li-space-lg">
                            ...
                            <li className="media">
                                <i className="fas fa-check" />
                                <div className="media-body">
                                    <strong className="blue">Convince them to buy</strong> your
                                    companys awesome products
                                </div>
                            </li>
                            <li className="media">
                                <i className="fas fa-check" />
                                <div className="media-body">
                                    <strong className="blue">Save precious time</strong> and invest
                        ...
                        <form id="requestForm" data-toggle="validator" data-focus="false">
                            ...
                            <div className="form-group">
                                <select className="form-control-select" id="rselect" required>
                                    <option className="select-option" value="" disabled selected>
                                        Interested in...
                                    </option>
                                    <option className="select-option" value="Personal Loan">
                                        Starter
                                    </option>
                                    <option className="select-option" value="Car Loan">
                                        Medium
                                    </option>
                                    <option className="select-option" value="House Loan">
                                        Complete
                                    </option>
                                </select>
                                <div className="help-block with-errors" />
